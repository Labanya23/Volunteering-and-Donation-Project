...
#def donorexperience(request):
    #if request.method == 'POST':
        # Save experience (optional)
        ##experience = request.POST.get('experience')
        # Save to DB if needed
    #return render(request, 'donorexperience.html')
def donor_experience(request):
    if request.method == 'POST':
        experience = request.POST.get('experience')
        # save to DB if needed
    return render(request, 'donorexperience.html')
...
#def donorexperience(request):
   ...
   # return render(request, "donorexperience.html", locals())
